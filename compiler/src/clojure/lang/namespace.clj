(ns clojure.lang.namespace
  (:require [clojure.lang.namespaced :refer [-namespace]]
            [clojure.lang.meta       :refer [-meta]]
            [clojure.lang.var        :refer [-alter-var-root make-var make-unbound]]))

(defn -create-ns [namespaces namespace-sym]
  (assoc-in namespaces [namespace-sym] {:mappings {}
                                        :aliases  {}
                                        :ns       namespace-sym}))
