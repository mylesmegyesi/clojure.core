(ns clojure.lang.persistent-array-map
  (:refer-clojure :only [defmacro declare defn defn- deftype let + - dec loop < / inc when when-let if-let even? format list list* bit-xor nil? ->])
